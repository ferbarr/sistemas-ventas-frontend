    ...
    <v-dialog persistent v-model="dialog" max-width="700px">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-spacer></v-spacer>
          <v-btn @click="guardarCliente()" v-if="this.btn.agregar"
            >Guardar</v-btn
          >
          <v-btn @click="editarCliente()" v-if="this.btn.editar">Editar</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <!-- MODAL ESTADO -->
        ...
        <v-card-text>
          <v-container>
            <span v-if="this.estado.estado === 1" class="black--text"
              >¿Deseas desactivar el cliente
              {{ this.estado.nombre }}?</span
            >
            <span v-if="this.estado.estado === 0" class="black--text"
              >¿Deseas activar el cliente {{ this.estado.nombre }}?</span
            >
          </v-container>
        </v-card-text>
        <v-card-actions>
